...
function error_checking_fwd(o::Union{HamFlow, HamFlowRot}, a::HF_params, n_mcmc::Int; Nsample::Int = 100, refresh::Function = pseudo_refresh_coord, inv_ref::Function = inv_refresh_coord)
    E = zeros(Nsample)
...
function error_checking_bwd(o::Union{HamFlow, HamFlowRot}, a::HF_params, n_mcmc::Int; Nsample::Int = 100, refresh::Function = pseudo_refresh_coord, inv_ref::Function = inv_refresh_coord)
    E = zeros(Nsample)
    prog_bar = ProgressMeter.Progress(Nsample, dt=0.5, barglyphs=ProgressMeter.BarGlyphs("[=> ]"), barlen=50, color=:yellow)
    for i ∈ 1:Nsample
        ρ0, u0 = o.ρ_sampler(o.d), rand()
